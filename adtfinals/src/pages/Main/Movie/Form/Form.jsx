  ...
  const handleSearch = useCallback(() => {
    ...
    axios.get(`https://api.themoviedb.org/3/search/movie?query=${query}&include_adult=false&language=en-US&page=${currentPage}`, {
      headers: {
        ...
        Authorization:  'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI1MTcwZGU1YzE5MWRjNDM5YTlhYTQ2NWIxNDljMGJkMSIsIm5iZiI6MTczMzMxOTk1Ny43NzIsInN1YiI6IjY3NTA1ZDE1ZmI3Mjk4YzExYTIxNmU3MCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.XUhD9Q6iV0LmcsCEkUnwwddUctpz1ynOUCo83a-mujA',
      },
    })
      .then((response) => {
